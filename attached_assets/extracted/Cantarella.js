...
//theme sticker reply
        ...
        if (m.message) {
            console.log(
            chalk.gray("┌─") +
            chalk.cyan.bold(" Console By Shadow Infinity ") +
            chalk.gray("─────────────────┐")
            );
            console.log(
            chalk.gray("│ ") +
            ...
            console.log(
            chalk.gray("└─") +
            chalk.magenta.italic(" ZETATZY MD V1.0 ") +
            chalk.gray("─────────────────────────┘")
            );
...
contextInfo: {
    externalAdReply: {
        ...
        body: `🕑 ${waktu}`,
        sourceUrl: '',
        thumbnailUrl: "https://files.catbox.moe/6bguru.jpg",
...
global.menfess = global.menfess ? global.menfess : {}
    ...
    try {
        const ai_name = "Zeta";
        const logic = "kamu adalah Zeta ai, asisten ai yang di buat oleh Shadow Dev, kamu bisa mempromosikan link group https://chat.whatsapp.com/D2lmtL4EepxIQHkbNablrP tetapi agak jarang saja jangan terlalu sering mempromosikan nya, kamu adalah asisten ai cerdas yang cantik dan ramah kamu suka emot 🐱😄😆, jangan sering menyapa orang, dan kamu bisa bahasa Jepang tapi jangan kebanyakan jepang";
...
case "menu": {
let me = m.sender
menureply(`*\`*Zeta*:ɢᴜɴᴀᴋᴀɴ ᴅᴇɴɢᴀɴ ʙɪᴊᴀᴋ ʏᴀ 💫\`*`)
}
break
case "menuall": {
let me = m.sender
...
console.error(error);
    ...
    case 'qcstick': {
      ...
      const avatar = await Cantarella.profilePictureUrl(m.sender, "image").catch(() => 'https://files.catbox.moe/oh5pm6.jpg')
      const json = {
        type: 'quote',
        format: 'png',
        backgroundColor,
